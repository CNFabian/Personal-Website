      ...
      <div className="content-wrapper">
        <div className="left-section">
          <div className="name-container">
            ...
            <h1 className="title">CHRISTOPHER</h1>
            <h1 className="title">FABIAN <FaInfoCircle className="info-icon" /></h1>
          </div>
        ...
        <div className="right-section">
          ...
          <div className="circular-icons">
            <div className="icon-circle1">
              ...
              <div class="icon-description">I love to express my creativity in my drawings, or more recently in Web Design</div>
            </div>
            
            <div className="icon-circle2">
              <img src={require('../assets/Group-3.png')}/>
              <div class="icon-description">Strong programming skills with high project expereince in Python, C++, and Javascript.</div>
            </div>
            
            <div className="icon-circle3 ">
              <img src={require('../assets/Group-1.png')}/>
              <div class="icon-description">Have skills in Data Analysis, hoping to find a career path in it</div>
            </div>
            
            <div className="icon-circle4 ">
              <img src={require('../assets/Group-2.png')}/>
              <div class="icon-description">Enjoy reading a good book, current favorite author is Stephen King</div>
            </div>
          </div>
        </div>
      </div>
